...
<div class="content">
	...
	<div class="row">
		...
		<a class="col-xl-3 col-md-6 mb-4" <?php if ($_SESSION['rol'] == 1 ) { ?>href="lista_usuarios.php"<?php } ?>>
		...
		<!-- Earnings (Monthly) Card Example -->
		<a class="col-xl-3 col-md-6 mb-4" <?php if ($_SESSION['rol'] == 1 ) { ?>href="lista_cliente.php"<?php } ?>>
		...
		<!-- Earnings (Monthly) Card Example -->
		<a class="col-xl-3 col-md-6 mb-4" <?php if ($_SESSION['rol'] == 1 ) { ?>href="lista_productos.php"<?php } ?>>
		...
		<a class="col-xl-3 col-md-6 mb-4" <?php if ($_SESSION['rol'] == 1 ) { ?>href="ventas.php"<?php } ?>>
	...
	<br><br>
	<a href="index_reportes.php">VER REPORTES ESTADISTICOS DE STOCK</a>
	<!-- Page Heading -->
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
